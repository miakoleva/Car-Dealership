...
import com.example.cardealershipapp.model.exceptions.PasswordsDoNotMatchException;
...
public class RegisterController {
    ...
    public String register(@RequestParam String username,
        ...
        try {
            this.userService.register(username, password, repeatedPassword, name, surname, mobileNumber, Role.ROLE_RENTER);
